package kr.co.icia.plzec.services;
...
/* 필수 라이브러리
 *  spring-security-crypto 최신라이브러리
 *  commons-codec 1.15
 */

@Component
public class Encryption implements PasswordEncoder{
	// Spring Security가 기본적을 제공하는 암호화 기법 : 비번저장 해독안해줌, SHA 기반
	private PasswordEncoder passwordEncoder;

	public Encryption() {
		this.passwordEncoder = new BCryptPasswordEncoder();//바이너리로인코딩
	}
